...
class FoundationGapDetector {
  ...
  normalizeTopic(topic) {
    ...
    const topicMap = {
      ...
      "series and sequences": "series_sequences",
      series: "series_sequences",
      sequences: "series_sequences",
      "3d coordinate geometry": "coordinate_geometry_3d",
      "coordinate geometry 3d": "coordinate_geometry_3d",
      "coordinate geometry": "coordinate_geometry_3d",

      // Physical sciences (unchanged)
