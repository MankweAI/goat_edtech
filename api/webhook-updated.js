/**
 * Updated ManyChat Webhook with Correct Menu
 * GOAT Bot 2.0 - SA Student Companion
 * User: sophoniagoat
 * Updated: 2025-08-20 19:41:27 UTC
 */
...
module.exports = async (req, res) => {
  try {
    ...
    // Main menu - your exact specification
    if (
    ...
    // Option 2: Homework Help
      ...
      response = {
        ...
        status: "success",
        echo: "Homework help mode activated",
        timestamp: new Date().toISOString(),
    ...
    // Option 3: Tips & Hacks
      ...
      response = {
        ...
        status: "success",
        echo: "Tips & hacks mode activated",
        timestamp: new Date().toISOString(),
